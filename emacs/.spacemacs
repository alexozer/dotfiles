...
before packages are loaded."
  ...
  (slack-register-team
   :name "CUAUV"
   :default t
   :client-id "aso26@cornell.edu"
   :client-secret (shell-command-to-string "gopass show slackcuauv")
   :token "token"
   :subscribed-channels '(general slackbot software))
)
